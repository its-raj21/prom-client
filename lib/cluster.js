...
let registries = [globalRegistry];
let requestCtr = 0; // Concurrency control
let listenersAdded = false;
const requests = new Map(); // Pending requests for workers' local metrics.

class AggregatorRegistry extends Registry {
	constructor(regContentType = PROMETHEUS_CONTENT_TYPE) {
	 ...
	 */
	static aggregate(metricsArr, registryType = PROMETHEUS_CONTENT_TYPE) {
...
export default AggregatorRegistry;

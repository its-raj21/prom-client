import { globalRegistry, PROMETHEUS_CONTENT_TYPE } from './registry.js';
import { isObject } from './util.js';
import { validateMetricName, validateLabelName } from './validation.js';
	...
	constructor(config, defaults = {}) {
		...
		for (const register of this.registers) {
			if (
				...
				register.contentType === PROMETHEUS_CONTENT_TYPE
			) {
				throw new TypeError(

...
import { getLabels, hashObject, removeLabels } from './util.js';
import { validateLabel } from './validation.js';
import { Metric } from './metric.js';
import timeWindowQuantiles from './timeWindowQuantiles.js';
...
function observe(labels) {
	return value => {
		...
		if (!Number.isFinite(labelValuePair.value)) {
			throw new TypeError(
				`Value is not a valid number: ${format(labelValuePair.value)}`,
			);
		}

export const getValueAsString = function getValueString(value) {
...
export function removeLabels(hashMap, labels, sortedLabelNames) {
	const hash = hashObject(labels, sortedLabelNames);
	delete hashMap[hash];
}

export function setValue(hashMap, value, labels) {
...
export function setValueDelta(hashMap, deltaValue, labels, hash = '') {
...
export function getLabels(labelNames, args) {
...
const _hashObject = hashObject;
export { _hashObject as hashObject };
...
const _Grouper = Grouper;
export { _Grouper as Grouper };
